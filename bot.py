...
Натисни меню нижче, щоб розпочати 👇"""
    ...
    **🏷️ Керування Мітками (Тегами):**
    * **Щоб додати мітку:** Відповідайте (Reply) на тікет користувача, починаючи з **#tag_[МІТКА]** (наприклад: `#tag_КМ_535 Це відповідь`).
    * **Результат:** Мітка зберігається в БД і відображається у всіх майбутніх тікетах від цього користувача.
    """
